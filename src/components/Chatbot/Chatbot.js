...
const Chatbot = () => {
    ...
    const initialMessage = {
        sender: 'bot',
        text: "Hi there! I'm a chatbot designed to help you explore Abhinav's portfolio. You can ask me about his 'skills', 'experience', 'projects', or even about 'Abhinav' himself."
    };

    // Function to scroll the entire window back to the top
    const handleGoHome = () => {
        window.scrollTo({
            top: 0,
    ...
    return (
        <div className={styles.chatbotContainer}>
            ...
            {/* NEW BUTTON ADDED BELOW THE FORM */}
            <button 
